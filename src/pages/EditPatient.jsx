...
const EditPatient = () => {
    ...
    const onSubmit = async (event) => {
      ...
      try {
        ...
        alert("Edit infomation Patient successfully!");
        console.log("Edit infomation Patient successfully");
        navigate("/list");
      } catch (err) {
    ...
    return (
      <div>
        <Header>
          <H1 className="mt-8 text-center">Edit Info Patient</H1>
          ...
          In a blockchain system, when you edit information of a record, you essentially create a new record and overwrite the old record.
          </p>
        </Header>
